...
namespace DomainLayer.Dtos
{
    ...
    public class AdministratorCreationDto : AdministratorAddAndUpdateDto { }

    public class AdministratorUpdateDto : AdministratorAddAndUpdateDto { }

    public abstract class AdministratorAddAndUpdateDto
    {
